...
def test_entrypoint_is_thin_and_modules_exist():
    ...
    for module in ("config.py", "diagnostics.py", "incidents.py", "policies.py", "retry.py", "scanner.py", "schema.py", "startup.py", "translations.py", "miniapp_api.py", "bot.py"):
